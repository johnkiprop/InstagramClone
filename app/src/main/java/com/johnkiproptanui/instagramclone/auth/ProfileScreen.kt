...
import com.johnkiproptanui.instagramclone.main.CommonDivider
import com.johnkiproptanui.instagramclone.main.CommonImage
...
fun ProfileContent(
    ...
    Column(
        ...
        Row(modifier= Modifier
            ...
            TextField(value= name, onValueChange = onUsernameChange, colors = TextFieldDefaults.textFieldColors(
                backgroundColor = Color.Transparent,
                textColor = Color.Black
            ) )
        }
