...
@Composable
fun NewPostScreen(navController: NavController, vm:InstagramViewModel, encodedUri: String){
    val imageUri by remember {mutableStateOf(encodedUri) }
    var description by rememberSaveable{ mutableStateOf("")}
    val scrollState = rememberScrollState()
    val focusManager = LocalFocusManager.current //to dismiss keyboard when we click btn
